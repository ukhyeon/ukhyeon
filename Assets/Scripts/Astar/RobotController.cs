   ...
   void Update()
{
    if (path != null && path.Length > 0 && targetIndex < path.Length)
    {
        ...
        if (angleDifference >= 30f) {
            rotationSpeed = 20f; alpha=0.3f;
        } else if (angleDifference >= 20f && angleDifference < 30f) {
            rotationSpeed = 15f; alpha=0.5f;
        } else if (angleDifference >= 10f && angleDifference < 20f) {
            rotationSpeed = 10f; alpha=0.7f;
        } else if (angleDifference >= 5f && angleDifference < 10f) {
            rotationSpeed = 3f; alpha=0.8f;
        } else if (angleDifference < 5f) {
            rotationSpeed = 5f;
        }
        ...
        transform.Translate(Vector3.forward * moveDistance*alpha*3);
